...
--
-- Host: localhost
-- Generation Time: Jun 25, 2014 at 09:11 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Table to list all present categories' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Details about the inventory' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `item_details` (
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table for Item details' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `item_inventory_mapping`
--

CREATE TABLE IF NOT EXISTS `item_inventory_mapping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inventory_id` int(111) NOT NULL,
...
--
-- Constraints for table `item_inventory_mapping`
--
ALTER TABLE `item_inventory_mapping`
  ADD CONSTRAINT `item_inventory_mapping_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item_details` (`item_id`),
  ADD CONSTRAINT `item_inventory_mapping_ibfk_1` FOREIGN KEY (`inventory_id`) REFERENCES `inventory_details` (`inventory_id`);
